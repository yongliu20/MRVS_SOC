...
class ReferYouTubeVOSDataset(Dataset):
    ...
    """
    def __init__(self, subset_type: str = 'train', dataset_path: str = '/opt/tiger/ljyaronld/rvosdata/refer_davis',
        ...
        dataset_path = '/opt/tiger/ljyaronld/rvosdata/refer_davis'
        if subset_type == 'test':
    ...
    def __getitem__(self, idx):
        ...
        if self.subset_type == 'train':
            with open(path.join('/opt/tiger/ljyaronld/rvosdata/refer_youtube_vos/train', 'meta.json'), 'r') as f:
...
if __name__ == "__main__":
    dataset_path = "/opt/tiger/ljyaronld/rvosdata/ref-davis"
    subset_type = 'valid'
    distributed = False
