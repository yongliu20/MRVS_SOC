...
class A2DSentencesDataset(Dataset):
    ...
    """
    def __init__(self, subset_type: str = 'train', dataset_path: str = '/opt/tiger/ljyaronld/rvosdata/a2d_sentences', window_size=8,
    ...
    def get_text_annotations(root_path, subset, distributed):
        saved_annotations_file_path = f'/opt/tiger/ljyaronld/rvosdata/a2d_sentences/a2d_sentences_single_frame_{subset}_annotations.json'
