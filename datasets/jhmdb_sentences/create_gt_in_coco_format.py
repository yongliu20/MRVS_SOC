...
if __name__ == '__main__':
    dataset_path = "/opt/tiger/ljyaronld/rvosdata/jhmdb_sentences"
    sample_meta = get_samples_metadata(dataset_path, generate_new_samples_metadata=False, distributed=False)
    subset_type = 'test'
    output_path = f'/opt/tiger/ljyaronld/rvosdata/jhmdb_sentences/jhmdb_sentences_{subset_type}_annotations_in_coco_format.json'
